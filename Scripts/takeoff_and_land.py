...
class Plane():
    ...
    def arm_and_takeoff(self, altitude=100, pitch_deg=40):
        ...
        if self.vehicle.armed: 
            ...
            waypoint3 = LocationGlobalRelative(53.3833284, 30.8496094, 100)
    ...
    def go_to_waypoint1(self):
        waypoint1 = LocationGlobalRelative(46.8000594, 14.1943359, 100)
        self.vehicle.simple_goto(waypoint1)

    def go_to_waypoint2(self):
        waypoint2 = LocationGlobalRelative(46.4983923, 47.9003906, 100)
        self.vehicle.simple_goto(waypoint2)
